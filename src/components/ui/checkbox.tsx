...
function Checkbox({
  ...
  icon: Icon = CheckIcon,
  ...props
}: React.ComponentProps<typeof CheckboxPrimitive.Root> & { icon?: LucideIcon }) {
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="[&>svg]:size-5 grid place-content-center text-current transition-none"
      >
        {Icon && <Icon className="w-4 h-4 text-white stroke-current" />}
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  );
}
